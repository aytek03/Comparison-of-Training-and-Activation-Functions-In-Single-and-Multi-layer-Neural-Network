function [MSE,alloutputs] = experiment4(neuron1,neuron2,train_algorithm,activation_func1,activation_func2)

% AYTEKÝN YILDIZHAN
% N18147923
% CMP684 Neural Networks Project 2b

%----------------------------------------------------------------
% This script is a multi-layer pattern recognition network, 
% and takes 5 parameters, which is 
...
%[MSE,alloutputs] = experiment4(2,2,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(2,2,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(2,2,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(2,2,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 4 x 4

%[MSE,alloutputs] = experiment4(4,4,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(4,4,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(4,4,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(4,4,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 8 x 8

%[MSE,alloutputs] = experiment4(8,8,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(8,8,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(8,8,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(8,8,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 16 x 16

%[MSE,alloutputs] = experiment4(16,16,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(16,16,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(16,16,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(16,16,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 32 x 32

%[MSE,alloutputs] = experiment4(32,32,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(32,32,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(32,32,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(32,32,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 64 x 64

%[MSE,alloutputs] = experiment4(64,64,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(64,64,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(64,64,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(64,64,'trainlm','hardlim','hardlim');

%--------------------------------------------------------------------

% #NEURON = 128 x 128

%[MSE,alloutputs] = experiment4(128,128,'trainlm','tansig','tansig');
%[MSE,alloutputs] = experiment4(128,128,'trainlm','logsig','logsig');
%[MSE,alloutputs] = experiment4(128,128,'trainlm','purelin','purelin');
%[MSE,alloutputs] = experiment4(128,128,'trainlm','hardlim','hardlim');
...
%You can use patternnet([neuron1,neuron2],trainFcn) instead of feedforwardnet
...
net.layers{3}.transferFcn = 'softmax'; %output neuron is softmax
